        ...
        <div className="relative z-10">
          ...
          <section className="flex justify-center mt-12">
            <div className="flex flex-row items-center justify-center gap-10">
              <div className="rounded-2xl bg-[#e7ffdf] shadow-[0px_4px_12px_rgba(0,_0,_0,_0.25)] overflow-hidden flex items-center justify-center py-2.5 px-4 gap-4">
                <img className="w-10 h-10" src="/frame.svg" alt="" />
                <span className="uppercase font-semibold text-2xl">
                  Okay to buy
                </span>
              </div>
              <div className="rounded-2xl bg-[#fff8d4] shadow-[0px_4px_12px_rgba(0,_0,_0,_0.25)] overflow-hidden flex items-center justify-center py-2.5 px-4 gap-4">
                <img className="w-10 h-10" src="/caution.svg" alt="" />
                <span className="uppercase font-semibold text-2xl">
                  Caution
                </span>
              </div>
